...
import com.example.travelbee.adapters.TodayItemsAdapter;
import com.example.travelbee.models.Data;
...
public class BudgetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Today's Spending");
        ...
        ref = FirebaseDatabase.getInstance().getReference("Users").child(onlineUserId).child("expenses");
//        ref = FirebaseDatabase.getInstance().getReference().child("expenses");
        ...
        todayItemsAdapter = new TodayItemsAdapter(BudgetActivity.this, myDataList);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mItem.equalsIgnoreCase("Select item")){
                    Toast.makeText(BudgetActivity.this, "Please select a valid item", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    ref.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(BudgetActivity.this, "Failed to add Item", Toast.LENGTH_SHORT).show();
                            }
                            loader.dismiss();
                        }
                    });
